        ...
        <div className="border border-border mb-8">
          ...
          <div className="p-6">
            <div className="flex flex-wrap gap-3">
              ...
              {/* GitHub connected for stars (if different from primary auth) */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          >
            <p className="text-3xl font-light tabular-nums mb-1">
              ...
              <span className="text-sm text-muted font-normal">/{maxStars}</span>
            </p>
            <p className="text-sm text-muted group-hover:text-black transition-colors">
              <span
        ...
        <div id="star-to-unlock" className="border border-border scroll-mt-6">
          ...
          <div className="p-6">
            ...
            <p className="text-sm text-muted text-center pt-4 border-t border-border">
              Star a repo = {GITHUB_CONFIG.DAYS_PER_STAR} days membership | Max {GITHUB_CONFIG.MAX_DAYS} days
            </p>
          </div>
        </div>
      </main>
