# LaTeX Writer - Implemented Features

## Overview

LaTeX Writer is a collaborative LaTeX editing platform with real-time sync, similar to Overleaf.
...
- `latex-writer compile` - Compile LaTeX locally
- `latex-writer watch` - Watch mode compilation
- `latex-writer init` - Initialize from templates
- `latex-writer login` - Authenticate with web service
