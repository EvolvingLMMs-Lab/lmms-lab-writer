...
export async function GET(request: Request) {
  ...
  if (code) {
    // Use SSR client to exchange code for session (handles PKCE automatically)
    ...
    // For desktop flow, redirect to desktop-success with tokens
    if (source === "desktop") {
      console.log("[auth/callback] Desktop flow - redirecting with tokens");
